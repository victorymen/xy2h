...
function addToFavorite() {
    var a = "http://www.xy2h.com/", b = "\u4eac\u4e1cxy2h.com-\u7f51\u8d2d\u4e0a\u4eac\u4e1c\uff0c\u7701\u94b1\u53c8\u653e\u5fc3";
    document.all ? window.external.AddFavorite(a, b) : window.sidebar && window.sidebar.addPanel ? window.sidebar.addPanel(b, a, "") : alert("\u5bf9\u4e0d\u8d77\uff0c\u60a8\u7684\u6d4f\u89c8\u5668\u4e0d\u652f\u6301\u6b64\u64cd\u4f5c!\n\u8bf7\u60a8\u4f7f\u7528\u83dc\u5355\u680f\u6216Ctrl+D\u6536\u85cf\u672c\u7ad9\u3002"), createCookie("_fv", "1", 30, "/;domain=xy2h.com")
}
function search(a) {
    var b = "http://search.xy2h.com/Search?keyword={keyword}&enc={enc}{additional}", c = search.additinal || "", d = document.getElementById(a), e = d.value;
    ...
    switch (f) {
        ...
        case 5:
            ...
            b = "http://search.e.xy2h.com/searchDigitalBook?ajaxSearch=0&enc=utf-8&key={keyword}&page=1{additional}";
            break;
        case 6:
            i = "-1", b = "http://music.xy2h.com/8_0_desc_0_0_1_15.html?key={keyword}"
    }
...
var loguri = "http://csc.xy2h.com/log.ashx?type1=$type1$&type2=$type2$&data=$data$&pin=$pin$&referrer=$referrer$&callback=?";
callback1 = function() {
}, log = function(a, b) {
    var c = "";
    ...
    var e = ("https:" == document.location.protocol ? "https://mercuryssl" : "http://mercury") + ".xy2h.com/log.gif" + "?t=other.000000" + "&m=UA-J2011-1" + "&v=" + encodeURIComponent("t1=" + a + "$t2=" + b + "$p0=" + c) + "&ref=" + encodeURIComponent(document.referrer) + "&rm=" + (new Date).getTime(), f = new Image(1, 1);
    f.src = e
}, mark = function(a, b) {
    log(1, b, a)
