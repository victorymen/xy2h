...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/xy2h-logo.gif" alt="二货"></a></div>
</div>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">源动力小组</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">158****8888</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">中国 江苏 苏州独墅湖高教区</div>
						<div class="adr-m" limit="30">仁爱路188号 中科大苏州研究院</div>
				...
				<li style="cursor: pointer;" onclick="save_Pay(1);">
					<div class="payment-item item-selected online-payment "
						...
						<b></b> 货到付款<span class="qmark-icon qmark-tip"
							data-tips="送货上门后再收款，支持现金、POS机刷卡、支票支付 <a href='http://help.xy2h.com/help/distribution-768-2-2813-2863-0-1410707152669.html' target='_blank' class='ftx-05'>查看服务及配送范围</a>"></span>
						<!--  span class="qmark-icon qmark-tip" data-tips="在线支付，支持绝大多数银行借记卡及部分银行信用卡 <a href='http://help.xy2h.com/help/question-68.html' target='_blank' class='ftx-05'>查看银行及限额</a>"></span -->
						<!-- span class="qmark-icon qmark-tip" data-tips="送货上门后再收款，支持现金、POS机刷卡、支票支付 <a target='_blank' href='http://psfw.xy2h.com/help/distribution-768.html-2-2825-2893-0-1427094595258.html'>查看服务及配送范围</a>"></span -->
					</div>
				</li>
				<li style="cursor: pointer;" onclick="save_Pay(4);">
					...
					<div class="payment-item  online-payment "
						...
						<b></b> 在线支付 <font class="whiteBarSpanClass hide"
							...
							data-tips="即时到帐，支持绝大数银行借记卡及部分银行信用卡 <a href='http://www.xy2h.com/help/onlinepay.aspx' target='_blank' class='ftx-05'> 查看银行及限额</a>"></span>
						<!--  span class="qmark-icon qmark-tip" data-tips="在线支付，支持绝大多数银行借记卡及部分银行信用卡 <a href='http://help.xy2h.com/help/question-68.html' target='_blank' class='ftx-05'>查看银行及限额</a>"></span -->
						<!-- span class="qmark-icon qmark-tip" data-tips="即时到帐，支持绝大数银行借记卡及部分银行信用卡 <a target='_blank' href='http://www.xy2h.com/help/onlinepay.aspx'>查看银行及限额</a>"></span -->
					</div>
				</li>
				...
				<li style="cursor: pointer;" onclick="save_Pay(5); ">
					...
					<div class="payment-item online-payment "
						...
						<b></b> 公司转账 <span class="qmark-icon qmark-tip"
							data-tips="通过快钱平台转账 转帐后1-3个工作日内到帐 <a href='http://help.xy2h.com/help/question-70.html' target='_blank' class='ftx-05'>查看帐户信息</a>"></span>
						<!--  span class="qmark-icon qmark-tip" data-tips="在线支付，支持绝大多数银行借记卡及部分银行信用卡 <a href='http://help.xy2h.com/help/question-68.html' target='_blank' class='ftx-05'>查看银行及限额</a>"></span -->
						<!-- span class="qmark-icon qmark-tip" data-tips="通过快钱平台转账 转帐后1-3个工作日内到帐 <a target='_blank' href='http://help.xy2h.com/help/question-70.html'>查看帐户信息</a>"></span -->
					</div>
				</li>
				<li style="cursor: pointer;" onclick="save_Pay(2); ">
					...
					<div class="payment-item  online-payment "
						...
						<b></b> 邮局汇款 <span class="qmark-icon qmark-tip"
							data-tips="通过快钱平台收款 汇款后1-3个工作日到账 <a href='http://help.xy2h.com/help/question-69.html' target='_blank' class='ftx-05'>查看帮助</a>"></span>
						<!--  span class="qmark-icon qmark-tip" data-tips="在线支付，支持绝大多数银行借记卡及部分银行信用卡 <a href='http://help.xy2h.com/help/question-68.html' target='_blank' class='ftx-05'>查看银行及限额</a>"></span -->
						<!-- span class="qmark-icon qmark-tip" data-tips="通过快钱平台收款  汇款后1-3个工作日到账 <a target='_blank' href='http://help.xy2h.com/help/question-69.html'>查看帮助</a>"></span -->
					</div>
				</li> 
				<!--div id="shipment"></div--> 
				<script>
...
<div class="shopping-list ABTest">
	<div class="goods-list">
     <!--配送方式-->
    <h4 class="vendor_name_h" id="0">商家：二货</h4>
		...
		<div class="mode-tab-nav">
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">二货快递<i
						class='qmark-icon qmark-tip'
						data-tips='由二货公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b></li>
			</ul>
		</div>
	</div>
</div>
    ...
    <div class="ui-ceilinglamp checkout-buttons">
      ...
      <div class="sticky-wrap">
          ...
          <div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
            部分商品货到付款方式：先由二货配送“提货单”并收款，然后厂商发货。
          </div>
        </div>
